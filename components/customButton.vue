...
const goToMenu = () => {
  router.push({ name: 'business', params: { business: 0 } })
}

//Code pour aligner les svg aux centres
let svgElements = document.querySelectorAll('.icon-background > svg')
